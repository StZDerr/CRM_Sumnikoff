...
@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-semibold">Создать банковский счёт</h1>
        ...
        <div class="bg-white shadow rounded p-6">
            <form action="{{ route('bank-accounts.store') }}" method="POST" class="space-y-6">
                ...
                @include('admin.bank_accounts._form', ['bankAccount' => new \App\Models\BankAccount()])

                <div class="flex items-center justify-between">
                    <a href="{{ route('bank-accounts.index') }}" class="text-sm text-gray-500">Отмена</a>
