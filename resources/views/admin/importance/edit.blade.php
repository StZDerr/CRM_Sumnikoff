...
@section('content')
    <div class="max-w-3xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-semibold">Редактировать уровень важности #{{ $importance->id }}</h1>
        ...
        <div class="bg-white shadow rounded p-6">
            <form action="{{ route('importances.update', $importance) }}" method="POST" class="space-y-6">
                @csrf
                @method('PATCH')
                ...
                <div>
                    ...
                    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $importance->name)"
                        required autofocus />
                ...
                <div>
                    ...
                    <x-text-input id="slug" name="slug" type="text" class="mt-1 block w-full"
                        :value="old('slug', $importance->slug)" />
                ...
                <div class="grid grid-cols-2 gap-4 items-center">
                    <div>
                        ...
                        <x-text-input id="color" name="color" type="text" class="mt-1 block w-full"
                            :value="old('color', $importance->color ?? '')" placeholder="#4F46E5" />
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="color_preview" type="color" class="w-12 h-10 p-0 border rounded"
                                value="{{ old('color', $importance->color ?? '#CBD5E1') }}"
                ...
                <div>
                    ...
                    <x-text-input id="sort_order" name="sort_order" type="number" class="mt-1 block w-48"
                        :value="old('sort_order', $importance->sort_order)" placeholder="1" min="1" />
                    <div class="text-xs text-gray-500 mt-1">1 = первая в списке. Оставьте пустым для авто.</div>
