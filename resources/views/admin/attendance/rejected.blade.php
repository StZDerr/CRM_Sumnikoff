...
@section('content')
    <div class="max-w-6xl mx-auto px-4 py-6">
        <h1 class="text-xl font-semibold mb-4">Табели отклоненные</h1>
            ...
            <tbody>
                @foreach ($reports as $report)
                    <tr class="border-b">
                        ...
                        <td class="p-3">
                            <a href="{{ route('rejected.userShow', $report->id) }}"
                                class="px-2 py-1 bg-blue-600 text-white rounded hover:bg-blue-700">Просмотр для правок</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
