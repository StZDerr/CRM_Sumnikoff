    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800">
                {{ isset($accountCredential) ? 'Редактировать доступ' : 'Создать доступ к FTP проекта ' . $project->title }}
            </h1>
        ...
        <div class="bg-white shadow-md rounded-lg border border-gray-200 p-6">
            <form
                action="{{ isset($accountCredential)
                    ...
                    : route('account-credentials.storeFTP', $project) }}"
                method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name"
                            value="{{ old('name', $accountCredential->name ?? 'Доступ к FTP') }}"
